...
function view(data) {
  ...
  data.forEach(function (item) {
    ...
    // 设置key
    arr.push((0, _snabbdom.h)('li', {
      key: item
    }, [(0, _snabbdom.h)('input', {
      attrs: {
        type: 'checkbox'
      }
    }), (0, _snabbdom.h)('span', item)]));
  });
  var vnode = (0, _snabbdom.h)('div', [(0, _snabbdom.h)('button', {
    on: {
